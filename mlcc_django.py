...
def auto_run_model(seg_cp_pth, date, pc_name, thr):
    ...
    args = {
        ...
        'det_cfg': 'D:/work_dir/det/1year+2year_detection_edit/detection.py',
        'det_cp': 'D:/work_dir/det/1year+2year_detection_edit/epoch_12.pth' ,
        'seg_cfg': 'D:/work_dir/seg/1year+2year_segmentation_edit/mlcc_sementic_1k_refine_small_aug_ssb.py',
        'seg_cp': 'D:/work_dir/seg/1year+2year_segmentation_edit/iter_20000.pth',
        'source': f'D:/mlcc_datasets/smb/{str(pc_name)}/input/',
        'gpu_id': '0',
        'score_thr': 0.30,
    ...
    for img_path in img_paths:           
        ...
        if not result['bboxes']:
            ...
            cv2.imwrite(('D:\mlcc_datasets\smb\data\_failed'+'\\'+result['img_basename']), a)
            continue
        else: 
            yield result
